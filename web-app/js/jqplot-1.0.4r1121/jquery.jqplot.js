...
(function($) {
    ...
    $.jqplot.LineRenderer.prototype.draw = function(ctx, gd, options, plot) {
        ...
        if (gd.length) {
                ...
                if (fill) {
                    ...
                    if (fillAndStroke) {
                        ...
                        if (this.markerRenderer.show) {
                            ...
                            if (this.markerRenderer.onlyFirst) {
                            	this.markerRenderer.draw(fasgd[0][0], fasgd[0][1], ctx, opts.markerOptions);
                            } 
                            else {
            ...
            if (this.markerRenderer.show && !fill) {
                ...
                if (this.markerRenderer.onlyFirst) {
                	this.markerRenderer.draw(gd[0][0], gd[0][1], ctx, opts.markerOptions);
                }
                else {
    ...
    */
    ...
    $.jqplot.MarkerRenderer = function(options){
        ...
        this.show = true;
        // prop: onlyFirst
        // whether to only draw the first marker for each line

			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastId" title="${message(code: 'album.lastId.label', default: 'Last Id')}" />
				...
				<g:each in="${albumInstanceList}" status="i" var="albumInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${albumInstance.id}">${fieldValue(bean: albumInstance, field: "lastId")}</g:link></td>
